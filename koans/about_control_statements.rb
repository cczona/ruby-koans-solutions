...
class AboutControlStatements < EdgeCase::Koan
  ...
  def test_unless_statement_only_executes_for_false_statement
    result = :default_value
    unless false
      result = :false_value
    end
  ...
  #CCZ#when modulus would result in a fraction between 0 and 1, result seems to always be 1.  WHY?
