...
class AboutMethods < EdgeCase::Koan
  ...
  def test_calling_global_methods_with_wrong_number_of_arguments
    ...
    assert_match(/wrong number of arguments \(0/, exception.message)

    exception = assert_raise(ArgumentError) do
      my_global_method(1,2,3)
    end
    assert_match(/wrong number of arguments \(3/, exception.message)
  end
  ...
  def test_calling_private_methods_without_explicit_receiver
